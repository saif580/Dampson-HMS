...
public class PdfService {
    ...
    public byte[] generateBillPdf(Billing billing) throws IOException {
        ...
        table.addCell(createCell("Patient First Name", true));
        table.addCell(createCell(billing.getPatientFirstName(), false));
        table.addCell(createCell("Patient Last Name", true));
        table.addCell(createCell(billing.getPatientLastName(), false));
