...
const LandingPage = () => {
  ...
  return (
    <div>
      <header className="header">
        <nav className="nav">
          <img
            ...
            id="logo"
          />
          <div className={`burger ${isBurgerOpen ? "open" : ""}`} onClick={toggleBurgerMenu}>
            <span></span>
            <span></span>
            <span></span>
          </div>
          <ul className={`nav__links ${isBurgerOpen ? "nav__links--open" : ""}`}>
            <li className="nav__item">
              <a className="nav__link" href="#section--1" onClick={toggleBurgerMenu}>
                Features
              </a>
            </li>
            <li className="nav__item">
              <a className="nav__link" href="#section--2" onClick={toggleBurgerMenu}>
                Booking
              </a>
            </li>
            <li className="nav__item">
              <a className="nav__link" href="#section--3" onClick={toggleBurgerMenu}>
                Testimonials
              </a>
            </li>
            <li className="nav__item">
              <a className="nav__link" href="#section--5" onClick={toggleBurgerMenu}>
                Contact
              </a>
            </li>
            <li className="nav__item">
      ...
      <section className="section section--sign-up" id="section--2">
        <div className="section__title">
          <h3 className="section__header">
      ...
      <footer className="footer" id="section--5">
        ...
        <p className="footer__copyright">
          &copy; Copyright by{" "}
          <a className="footer__link twitter-link" target="_blank" href="https://dampson.online">
            Dampson HMS
          </a>{" "}
